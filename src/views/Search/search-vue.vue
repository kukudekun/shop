      ...
      <div class="py-container">
        ...
        <div class="details clearfix">
            ...
            <div class="navbar-inner filter">
              <ul class="sui-nav">
                <li :class="{active:isOne}" @click="changeOrder('1')">
                  <a href="#">综合<i v-show="isOne&&isDesc">⬇</i><i v-show="isOne&&isAsc">↑</i></a>
                </li>
                <li :class="{active:isTwo}" @click="changeOrder('2')">
                  <a href="#">价格<i v-show="isTwo&&isDesc">⬇</i><i v-show="isTwo&&isAsc">↑</i></a>
                </li>
              </ul>
            </div>
          </div>
          <div class="goods-list">
            ...
            <Pagination-vue :total="total" :pageSize="searchParams.pageSize" :pageNo="searchParams.pageNo" :continues="5" @getPageNo="getPageNo"></Pagination-vue>
        </div>
      </div>
    </div>
  </div>
...
export default {
  ...
  beforeMount () {
    // 再发请求之前把接口需要传递的参数整理好，服务器返回查询的数据
